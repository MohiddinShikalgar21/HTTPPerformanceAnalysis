...
double reqresponse(char file_name[],int argc, char *argv[])	{
...
int main(int argc, char *argv[])
{
	...
	//file[]="text2.txt";
	double totaltime=0;
	totaltime+=reqresponse(file, argc, argv);
	char file2[10000]="test3.txt";
	totaltime+=reqresponse(file2, argc, argv);
	char file3[10000]="test4.txt";
	totaltime+=reqresponse(file3, argc, argv);
	totaltime += reqresponse("quit", argc, argv);
	printf("\n Throughput: %lf \n", 3/totaltime);
	return (0);
}
